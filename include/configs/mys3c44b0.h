...
#define CONFIG_MYBOARDS3C44B0			1	/* on an B2 Board      */
...
#define CONFIG_BOOTARGS  "setenv bootargs root=/dev/ram ip=192.168.0.90:::::eth0:off \
							 ether=25,0,0,0,eth0 ethaddr=00:50:c2:1e:af:fb"
#define CONFIG_NETMASK  255.255.255.0
#define CONFIG_IPADDR   192.168.0.90
#define CONFIG_SERVERIP	192.168.0.140
#define CONFIG_BOOTFILE	"imagerom.bin"
...
#define	CFG_LOAD_ADDR		0x0c100000	/* default load address	*/
